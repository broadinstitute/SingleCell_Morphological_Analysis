...
Use the following command on your machine by executing:
    ...
    $ bokeh serve eval_web_interface
 --allow-websocket-origin=ec2-54-173-122-228.compute-1.amazonaws.com:8183 --port 8183



Then navigate to the URL:

    http://ec2-54-90-165-206.compute-1.amazonaws.com:8181/Umap_DrugVsControl_lincs
